...
[![tests: 143 passing](https://img.shields.io/badge/tests-143%20passing-brightgreen?style=flat)](test/)
...
143 tests across two suites:

- **Unit tests (108)** — mock himalaya and test task logic in isolation
